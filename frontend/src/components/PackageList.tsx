...
const PackageList: React.FC<PackageListProps> = ({
  ...
  // ⚡ Bolt: Use useDeferredValue to prevent the expensive package filtering
  // from blocking the main UI thread during rapid typing in the search bar.
  // This ensures the input remains highly responsive while filtering happens in the background.
